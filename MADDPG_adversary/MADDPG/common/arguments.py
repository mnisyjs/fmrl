...
def get_args():
    ...
    parser.add_argument("--max-episodes", type=int, default=50000, help="number of training episodes")
    parser.add_argument("--time-steps", type=int, default=1250000, help="number of time steps")
    ...
    parser.add_argument("--alpha_policy_loss", type=float, default=0.3, help="weight for the policy loss in the total loss")
