...
from maddpg.maddpg_baseline import MADDPG_Baseline as MADDPG
import csv
...
class Runner:
    def __init__(self, args, env):
        ...
        self.adv_ids = self.env.agents[:self.args.num_adversaries]
        self.good_ids = self.env.agents[self.args.num_adversaries:]
    ...
    def run(self):
        for episode in range(self.args.start_episode, self.args.start_episode + self.args.max_episodes): # episode
            ...
            adv_name = self.adv_ids[0]
            good_names = self.good_ids
            g0, g1 = good_names
    ...
    def plot_rewards(self):
        ...
        plt.savefig(
            f'good_vs_adv_reward_seed{self.seed}.png',
            dpi=300,
            bbox_inches='tight'
        )
        plt.close()
        ...
        plt.savefig(
            f'total_reward_curve_seed{self.seed}.png',
            dpi=300,
            bbox_inches='tight'
        )
        plt.close()
